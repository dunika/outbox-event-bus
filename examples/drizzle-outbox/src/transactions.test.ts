...
import { OutboxEventBus } from "../../../src/outbox-event-bus"
import { DrizzleOutbox } from "./index"
...
describe("Drizzle Outbox Transactions with AsyncLocalStorage", () => {
  ...
  const eventBus = new OutboxEventBus<Db>(
    outbox,
